...
export const Summary = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>{commonState?.getAccountInfo("account_title")}</CardTitle>
        <CardDescription>
      ...
      <CardContent className="space-y-2">
        ...
        <div className="space-y-1">
          <Label htmlFor="last_transaction_date">Last Transaction Date</Label>
          <Input
            disabled
      ...
      <CardFooter>
        <Button>Create Mortgage Account</Button>
      </CardFooter>
    </Card>
  );
};
